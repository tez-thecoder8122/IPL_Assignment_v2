...
//   const medals = ['🥇', '🥈', '🥉'];
//   const cardColors = ['bowler-card-gold', 'bowler-card-silver', 'bowler-card-bronze'];
...
//               <Card key={index} className={`bowler-card ${cardColors[index]}`}>
//                 <CardContent className="bowler-card-content">
//                   <div className="bowler-medal">{medals[index]}</div>
//                   <div className="bowler-rank">#{index + 1}</div>
//                   <div className="bowler-name">{bowler.bowler}</div>
//                   <div className="bowler-economy">{parseFloat(bowler.economy_rate).toFixed(2)}</div>
//                   <div className="bowler-label">Economy Rate</div>
//                   <div className="bowler-stats">
//                     <div className="bowler-stats-item">Overs: {bowler.overs_bowled}</div>
//                     <div className="bowler-stats-item">Wickets: {bowler.wickets_taken}</div>
//                     <div className="bowler-stats-item">Runs: {bowler.runs_conceded}</div>
//                   </div>
//                 </CardContent>
//               </Card>
//             ))}
...
// src/pages/Bowlers.jsx - FIXED TOP 3 CARDS
import React, { useState, useEffect } from 'react';
import {
  Typography,
  Box,
